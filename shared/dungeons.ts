...
export const DUNGEONS: DungeonMeta[] = [
  {
    key: "shattered-throne",
    name: "Shattered Throne",
    destination: "Dreaming City · Ascendant",
  },
  {
    key: "pit-of-heresy",
    name: "Pit of Heresy",
  ...
  { key: "prophecy", name: "Prophecy", destination: "Realm of the Nine" },
  {
    ...
    destination: "Cosmodrome · Loot Cave",
  },
  { key: "duality", name: "Duality", destination: "Nightmare of Calus" },
  {
    key: "spire-of-the-watcher",
    name: "Spire of the Watcher",
    destination: "Mars · Seraph Station",
  },
  {
    key: "ghosts-of-the-deep",
    name: "Ghosts of the Deep",
    destination: "Titan · Flooded",
  },
  {
    key: "warlords-ruin",
    name: "Warlord's Ruin",
    destination: "Scorn Fortress",
  },
  {
    key: "vespers-host",
    name: "Vesper's Host",
    destination: "Icebreaker Station",
  },
]
