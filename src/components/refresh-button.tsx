...
export function RefreshButton() {
  ...
  return (
    <button
      ...
      className={`border-bungie-border hover:border-bungie-accent/50 relative flex h-9 w-9 items-center justify-center rounded-full border transition-colors ${
        anyFetching
          ? "text-bungie-accent"
          : "text-bungie-muted hover:text-white"
      }`}
    >
