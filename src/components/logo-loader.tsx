...
export function LogoLoader({
  ...
  return (
    <div className={`flex flex-col items-center gap-4 ${className}`}>
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            mask: "radial-gradient(circle, transparent 52%, #000 54%, #000 65%, transparent 67%)",
      ...
      {label && (
        <div className="fade-in-slow text-center text-[11px] font-extrabold tracking-[0.28em] text-white/60 uppercase">
          {label}
        </div>
      )}
      {showBar && (
