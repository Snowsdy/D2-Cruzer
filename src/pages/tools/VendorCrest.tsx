...
export function VendorCrest({ vendor, size = 40, style, ...props }: Props) {
    ...
    case "Banshee":
      return (
        ...
        >
          ...
          <path
            d="M32 8 Q38 16 38 24 L26 24 Q26 16 32 8 Z"
            fill={color}
            stroke={color}
            strokeWidth="1.5"
          />
    ...
    case "Hawthorne":
      return (
        ...
        >
          ...
          <path
            d="M32 18 L38 32 L32 48 L26 32 Z"
            fill={color}
            stroke={color}
            strokeWidth="1.5"
          />
    ...
    case "Xur":
      return (
        ...
        >
          ...
          <g>
            <path
              d="M32 6 L35 22 L29 22 Z"
              fill={`${color}55`}
              stroke={color}
              strokeWidth="1.3"
            />
            <path
              d="M50 12 L41 25 L37 20 Z"
              fill={`${color}55`}
              stroke={color}
              strokeWidth="1.3"
            />
            <path
              d="M58 28 L42 30 L42 24 Z"
              fill={`${color}55`}
              stroke={color}
              strokeWidth="1.3"
            />
            <path
              d="M56 48 L41 40 L44 36 Z"
              fill={`${color}55`}
              stroke={color}
              strokeWidth="1.3"
            />
            <path
              d="M42 58 L36 42 L32 45 Z"
              fill={`${color}55`}
              stroke={color}
              strokeWidth="1.3"
            />
            <path
              d="M22 58 L28 42 L32 45 Z"
              fill={`${color}55`}
              stroke={color}
              strokeWidth="1.3"
            />
            <path
              d="M8 48 L23 40 L20 36 Z"
              fill={`${color}55`}
              stroke={color}
              strokeWidth="1.3"
            />
            <path
              d="M6 28 L22 30 L22 24 Z"
              fill={`${color}55`}
              stroke={color}
              strokeWidth="1.3"
            />
            <path
              d="M14 12 L23 25 L27 20 Z"
              fill={`${color}55`}
              stroke={color}
              strokeWidth="1.3"
            />
