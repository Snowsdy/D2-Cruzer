...
export function AuthCallback() {
  ...
  return (
    <div className="h-full flex items-center justify-center p-6">
      <div className="panel p-8 text-center space-y-2 max-w-2xl">
        {error ? (
          <>
            <p className="text-red-400 font-semibold">{t("auth.error")}</p>
            <p className="text-sm text-bungie-muted break-all">{error}</p>
            <button
