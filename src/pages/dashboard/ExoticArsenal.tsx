  ...
  const SegmentButton = ({
    ...
    return (
      <button
        ...
        className={`flex items-center gap-2 rounded-full px-4 py-1.5 text-xs font-bold tracking-widest uppercase transition-all ${
          active
  ...
  return (
    <section>
      <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center gap-1 rounded-full border border-yellow-400/40 bg-black/30 p-1">
          <SegmentButton
            value="weapons"
        ...
        {items.length > PREVIEW_CAP && (
          <button
            ...
            className="text-xs font-semibold text-yellow-300 hover:underline"
          >
            {expanded
              ? `${t("common.less")} ↑`
      ...
      {items.length === 0 ? (
        <div className="panel text-bungie-muted p-6 text-center">
          ...
          {visible.map((e) => {
            ...
            return (
              <button
                ...
                className="group relative aspect-square overflow-hidden rounded-md border-2 border-yellow-400/70 bg-black transition-all hover:border-yellow-300 hover:shadow-[0_0_16px_rgba(250,204,21,0.5)]"
              ...
              >
                ...
                <div className="absolute inset-x-0 bottom-0 bg-linear-to-t from-black/95 to-transparent p-1.5 opacity-0 transition-opacity group-hover:opacity-100">
                  <div className="truncate text-[9px] font-bold text-yellow-300">
